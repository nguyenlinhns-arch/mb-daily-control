...
assert.match(index, /Báo cáo cho ngày hôm nay \(13\/08\/2026\)/i);
assert.match(index, /7 phương pháp cho ngày hôm nay \(13\/08\/2026\)/i);
assert.match(index, /Dữ liệu khóa đến hết ngày hôm qua \(12\/08\/2026\)/i);
